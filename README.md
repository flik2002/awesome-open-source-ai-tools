...
- **[chatchat-space/Langchain-Chatchat](https://github.com/chatchat-space/Langchain-Chatchat)** ⭐ 35,601 - Langchain-Chatchat（原 Langchain-ChatGLM）基于 Langchain 与 ChatGLM, Qwen 与 Llama 等语言模型的 RAG 与 Agent 应用 | Langchain-Chatchat...
...
- **[NirDiamant/RAG_Techniques](https://github.com/NirDiamant/RAG_Techniques)** ⭐ 18,879 - This repository showcases various advanced techniques for Retrieval-Augmented Generation (RAG) systems. RAG systems c...
...
- **[78/xiaozhi-esp32](https://github.com/78/xiaozhi-esp32)** ⭐ 16,597 - An MCP-based chatbot | 一个基于 MCP 的聊天机器人
...
- **[camel-ai/camel](https://github.com/camel-ai/camel)** ⭐ 13,370 - 🐫 CAMEL: The first and the best multi-agent framework. Finding the Scaling Law of Agents. https://www.camel-ai.org
...
- **[AstrBotDevs/AstrBot](https://github.com/AstrBotDevs/AstrBot)** ⭐ 10,573 - ✨ 易上手的多平台 LLM 聊天机器人及开发框架 ✨ 支持 QQ、QQ 频道、Telegram、微信、企微、飞书、钉钉 | 知识库、MCP 服务器、OpenAI、DeepSeek、Gemini、硅基流动、月之暗面、Ollama、OneA...
- **[chathub-dev/chathub](https://github.com/chathub-dev/chathub)** ⭐ 10,358 - All-in-one chatbot client
- **[sfyc23/EverydayWechat](https://github.com/sfyc23/EverydayWechat)** ⭐ 10,200 - 微信助手：1.每日定时给好友（女友）发送定制消息。2.机器人自动回复好友。3.群助手功能（例如：查询垃圾分类、天气、日历、电影实时票房、快递物流、PM2.5 等）
...
- **[zilliztech/GPTCache](https://github.com/zilliztech/GPTCache)** ⭐ 7,632 - Semantic cache for LLMs. Fully integrated with LangChain and llama_index.
...
- **[ChatAnyTeam/ChatAny](https://github.com/ChatAnyTeam/ChatAny)** ⭐ 6,532 - 🌻 一键拥有你自己的 ChatGPT+众多 AI 网页服务 | One click access to your own ChatGPT+Many AI web services
...
- **[docker/genai-stack](https://github.com/docker/genai-stack)** ⭐ 4,853 - Langchain + Docker + Neo4j + Ollama
...
- **[zhaoyingjun/chatbot](https://github.com/zhaoyingjun/chatbot)** ⭐ 3,582 - ChatGPT 带火了聊天机器人，主流的趋势都调整到了 GPT 类模式，本项目也与时俱进，会在近期更新 GPT 类版本。基于本项目和自己的语料可以训练出自己想要的聊天机器人，用于智能客服、在线问答、闲聊等场景。
...
- **[X-D-Lab/LangChain-ChatGLM-Webui](https://github.com/X-D-Lab/LangChain-ChatGLM-Webui)** ⭐ 3,274 - 基于 LangChain 和 ChatGLM-6B 等系列 LLM 的针对本地知识库的自动问答
...
- **[featureform/featureform](https://github.com/featureform/featureform)** ⭐ 1,927 - The Virtual Feature Store. Turn your existing data infrastructure into a feature store.
...
- **[CMU-Perceptual-Computing-Lab/openpose](https://github.com/CMU-Perceptual-Computing-Lab/openpose)** ⭐ 32,763 - OpenPose: Real-time multi-person keypoint detection library for body, face, hands, and foot estimation
...
- **[MLEveryday/100-Days-Of-ML-Code](https://github.com/MLEveryday/100-Days-Of-ML-Code)** ⭐ 21,857 - 100-Days-Of-ML-Code 中文版
...
- **[bee-san/Ciphey](https://github.com/bee-san/Ciphey)** ⭐ 19,682 - ⚡ Automatically decrypt encryptions without knowing the key or cipher, decode encodings, and crack hashes ⚡
...
- **[datawhalechina/leedl-tutorial](https://github.com/datawhalechina/leedl-tutorial)** ⭐ 15,453 - 《李宏毅深度学习教程》（李宏毅老师推荐 👍，苹果书 🍎），PDF 下载地址：https://github.com/datawhalechina/leedl-tutorial/releases
...
- **[bbfamily/abu](https://github.com/bbfamily/abu)** ⭐ 14,177 - 阿布量化交易系统(股票，期权，期货，比特币，机器学习) 基于 python 的开源量化交易，量化投资架构
...
- **[dragen1860/Deep-Learning-with-TensorFlow-book](https://github.com/dragen1860/Deep-Learning-with-TensorFlow-book)** ⭐ 13,263 - 深度学习入门开源书，基于 TensorFlow 2.0 案例实战。Open source Deep Learning book, based on TensorFlow 2.0 framework.
...
- **[ludwig-ai/ludwig](https://github.com/ludwig-ai/ludwig)** ⭐ 11,529 - Low-code framework for building custom LLMs, neural networks, and other AI models
...
- **[MorvanZhou/PyTorch-Tutorial](https://github.com/MorvanZhou/PyTorch-Tutorial)** ⭐ 8,330 - Build your neural network easy and fast, 莫烦 Python 中文教学
...
- **[LLM-Red-Team/kimi-free-api](https://github.com/LLM-Red-Team/kimi-free-api)** ⭐ 4,563 - 🚀 KIMI AI 长文本大模型逆向 API【特长：长文本解读整理】，支持高速流式输出、智能体对话、联网搜索、探索版、K1 思考模型、长文档解读、图像解析、多轮对话，零配置部署，多路 token 支持，自动清理会话痕迹，仅供测试，如需商用请前...
...
- **[snipsco/snips-nlu](https://github.com/snipsco/snips-nlu)** ⭐ 3,935 - Snips Python library to extract meaning from text
...
- **[scutan90/DeepLearning-500-questions](https://github.com/scutan90/DeepLearning-500-questions)** ⭐ 56,310 - 深度学习 500 问，以问答形式对常用的概率知识、线性代数、机器学习、深度学习、计算机视觉等热点问题进行阐述，以帮助自己及有需要的读者。 全书分为 18 个章节，50 余万字。由于水平有限，书中不妥之处恳请广大读者批评指正。 未完待续......
...
- **[binhnguyennus/awesome-scalability](https://github.com/binhnguyennus/awesome-scalability)** ⭐ 63,323 - The Patterns of Scalable, Reliable, and Performant Large-Scale Systems
...
- **[deepinsight/insightface](https://github.com/deepinsight/insightface)** ⭐ 25,878 - State-of-the-art 2D and 3D Face Analysis Project
...
- **[Zeyi-Lin/HivisionIDPhotos](https://github.com/Zeyi-Lin/HivisionIDPhotos)** ⭐ 18,427 - ⚡️HivisionIDPhotos: a lightweight and efficient AI ID photos tools. 一个轻量级的 AI 证件照制作算法。
...
- **[aleju/imgaug](https://github.com/aleju/imgaug)** ⭐ 14,622 - Image augmentation for machine learning experiments.
...
- **[hua1995116/awesome-ai-painting](https://github.com/hua1995116/awesome-ai-painting)** ⭐ 11,581 - AI 绘画资料合集（包含国内外可使用平台、使用教程、参数教程、部署教程、业界新闻等等） Stable diffusion、AnimateDiff、Stable Cascade 、Stable SDXL Turbo
- **[tangyudi/Ai-Learn](https://github.com/tangyudi/Ai-Learn)** ⭐ 11,445 - 人工智能学习路线图，整理近 200 个实战案例与项目，免费提供配套教材，零基础入门，就业实战！包括：Python，数学，机器学习，数据分析，深度学习，计算机视觉，自然语言处理，PyTorch tensorflow machine-lear...
...
- **[NVlabs/stylegan2](https://github.com/NVlabs/stylegan2)** ⭐ 11,130 - StyleGAN2 - Official TensorFlow Implementation
...
- **[AbdullahAlfaraj/Auto-Photoshop-StableDiffusion-Plugin](https://github.com/AbdullahAlfaraj/Auto-Photoshop-StableDiffusion-Plugin)** ⭐ 7,112 - A user-friendly plug-in that makes it easy to generate stable diffusion images inside Photoshop using either Automati...
...
- **[shobrook/adrenaline](https://github.com/shobrook/adrenaline)** ⭐ 3,787 - Chat with (and visualize) your codebase
...
- **[IceClear/StableSR](https://github.com/IceClear/StableSR)** ⭐ 2,491 - [IJCV2024] Exploiting Diffusion Prior for Real-World Image Super-Resolution
...
- **[LearnPrompt/LearnPrompt](https://github.com/LearnPrompt/LearnPrompt)** ⭐ 2,146 - 永久免费开源的 AIGC 课程, 目前已支持 Prompt Engineering, ChatGPT, Midjourney, Runway, Stable Diffusion, AI 数字人，AI 声音&音乐，开源大模型
...
- **[km1994/LLMsNineStoryDemonTower](https://github.com/km1994/LLMsNineStoryDemonTower)** ⭐ 2,085 - 【LLMs 九层妖塔】分享 LLMs 在自然语言处理（ChatGLM、Chinese-LLaMA-Alpaca、小羊驼 Vicuna、LLaMA、GPT4ALL 等）、信息检索（langchain）、语言合成、语言识别、多模态等领域（Sta...
...
- **[sudoskys/StableDiffusionBook](https://github.com/sudoskys/StableDiffusionBook)** ⭐ 1,957 - How do we integrate AI generation tools into actual work? | 关于 Ai 绘画的 Wiki | Wiki about Ai painting | Prompts Engineer...
...
- **[apchenstu/sofgan](https://github.com/apchenstu/sofgan)** ⭐ 774 - [TOG 2022] SofGAN: A Portrait Image Generator with Dynamic Styling
...
- **[jojomi/docker-hugo](https://github.com/jojomi/docker-hugo)** ⭐ 252 - Docker image for hugo static page generator (https://gohugo.io)
- **[unibas-gravis/parametric-face-image-generator](https://github.com/unibas-gravis/parametric-face-image-generator)** ⭐ 242 - Generate fully parametric face images from the Basel Face Model 2017
- **[iTzArshia/GPT-Discord-Bot](https://github.com/iTzArshia/GPT-Discord-Bot)** ⭐ 239 - 🧠 Example Discord Bot written in JavaScript that uses OpenAIs models such as ,`GPT 4`, `GPT-3.5-Turbo`, `Dall-E`, and...
- **[lukaskubanek/LoremIpsum](https://github.com/lukaskubanek/LoremIpsum)** ⭐ 231 - A lightweight lorem ipsum and image placeholders generator for Objective-C
- **[notunderctrl/image-generator-bot](https://github.com/notunderctrl/image-generator-bot)** ⭐ 230 - An AI powered image generator Discord Bot using Discord.js and Replicate.

## Marketing & Advertising

_AI-powered marketing tools, analytics, and advertising solutions._

- **[mli/paper-reading](https://github.com/mli/paper-reading)** ⭐ 30,786 - 深度学习经典、新论文逐段精读
- **[gitroomhq/postiz-app](https://github.com/gitroomhq/postiz-app)** ⭐ 22,582 - 📨 The ultimate social media scheduling tool, with a bunch of AI 🤖
- **[nautechsystems/nautilus_trader](https://github.com/nautechsystems/nautilus_trader)** ⭐ 9,747 - A high-performance algorithmic trading platform and event-driven backtester
- **[tensorzero/tensorzero](https://github.com/tensorzero/tensorzero)** ⭐ 8,586 - TensorZero is an open-source stack for industrial-grade LLM applications. It unifies an LLM gateway, observability, o...
- **[krishnaik06/Roadmap-To-Learn-Generative-AI-In-2024](https://github.com/krishnaik06/Roadmap-To-Learn-Generative-AI-In-2024)** ⭐ 4,167 - No description available

## Music & Audio

_AI tools for music generation, audio processing, and sound creation._

- **[huggingface/transformers](https://github.com/huggingface/transformers)** ⭐ 147,007 - 🤗 Transformers: the model-definition framework for state-of-the-art machine learning models in text, vision, audio, a...
- **[fighting41love/funNLP](https://github.com/fighting41love/funNLP)** ⭐ 74,811 - 中英文敏感词、语言检测、中外手机/电话归属地/运营商查询、名字推断性别、手机号抽取、身份证抽取、邮箱抽取、中日文人名库、中文缩写库、拆字词典、词汇情感值、停用词、反动词表、暴恐词表、繁简体转换、英文模拟中文发音、汪峰歌词生成器、职业名...
- **[CorentinJ/Real-Time-Voice-Cloning](https://github.com/CorentinJ/Real-Time-Voice-Cloning)** ⭐ 54,705 - Clone a voice in 5 seconds to generate arbitrary speech in real-time
- **[unslothai/unsloth](https://github.com/unslothai/unsloth)** ⭐ 42,141 - Fine-tuning & Reinforcement Learning for LLMs. 🦥 Train Qwen3, Llama 4, DeepSeek-R1, Gemma 3, TTS 2x faster with 70% l...
- **[coqui-ai/TTS](https://github.com/coqui-ai/TTS)** ⭐ 41,398 - 🐸💬 - a deep learning toolkit for Text-to-Speech, battle-tested in research and production
- **[mxgmn/WaveFunctionCollapse](https://github.com/mxgmn/WaveFunctionCollapse)** ⭐ 24,137 - Bitmap & tilemap generation from a single example with the help of ideas from quantum mechanics
- **[RasaHQ/rasa](https://github.com/RasaHQ/rasa)** ⭐ 20,404 - 💬 Open source machine learning framework to automate text- and voice-based conversations: NLU, dialogue management,...
- **[NVIDIA/NeMo](https://github.com/NVIDIA/NeMo)** ⭐ 15,100 - A scalable generative AI framework built for researchers and developers working on Large Language Models, Multimodal,...
- **[Dujltqzv/Some-Many-Books](https://github.com/Dujltqzv/Some-Many-Books)** ⭐ 14,756 - 个人收藏书籍列表　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　...
- **[lTbgykio/Books-Free-Books](https://github.com/lTbgykio/Books-Free-Books)** ⭐ 13,305 - 免费书籍汇总。　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　...
- **[sloria/TextBlob](https://github.com/sloria/TextBlob)** ⭐ 9,393 - Simple, Pythonic, text processing--Sentiment analysis, part-of-speech tagging, noun phrase extraction, translation, a...
- **[FoundationVision/VAR](https://github.com/FoundationVision/VAR)** ⭐ 8,313 - [NeurIPS 2024 Best Paper Award][GPT beats diffusion🔥] [scaling laws in visual generation📈] Official impl. of "Visual ...
- **[NexaAI/nexa-sdk](https://github.com/NexaAI/nexa-sdk)** ⭐ 4,610 - Nexa SDK is a comprehensive toolkit for supporting GGML and ONNX models. It supports text generation, image generatio...
- **[riffusion/riffusion-hobby](https://github.com/riffusion/riffusion-hobby)** ⭐ 3,755 - Stable diffusion for real-time music generation
- **[PeterH0323/Streamer-Sales](https://github.com/PeterH0323/Streamer-Sales)** ⭐ 3,358 - Streamer-Sales 销冠 —— 卖货主播 LLM 大模型 🛒🎁，一个能够根据给定的商品特点从激发用户购买意愿角度出发进行商品解说的卖货主播大模型。🚀⭐ 内含详细的数据生成流程 ❗ 📦 另外还集成了 LMDeploy 加速推理 🚀、RA...
- **[riffusion/riffusion-app-hobby](https://github.com/riffusion/riffusion-app-hobby)** ⭐ 2,663 - Stable diffusion for real-time music generation (web app)
- **[AJaySi/AI-Writer](https://github.com/AJaySi/AI-Writer)** ⭐ 502 - 🚀 ALwrity - AI-Powered Content Creation & SEO Platform. Generate blogs, social media content, and marketing copy with...
- **[VinAIResearch/WaveDiff](https://github.com/VinAIResearch/WaveDiff)** ⭐ 421 - Official Pytorch Implementation of the paper: Wavelet Diffusion Models are fast and scalable Image Generators (CVPR'23)

## Other AI Tools

_Miscellaneous AI applications and specialized tools._

- **[d2l-ai/d2l-zh](https://github.com/d2l-ai/d2l-zh)** ⭐ 70,739 - 《动手学深度学习》：面向中文读者、能运行、可讨论。中英文版被 70 多个国家的 500 多所大学用于教学。
- **[tesseract-ocr/tesseract](https://github.com/tesseract-ocr/tesseract)** ⭐ 68,179 - Tesseract Open Source OCR Engine (main repository)
- **[hiyouga/LLaMA-Factory](https://github.com/hiyouga/LLaMA-Factory)** ⭐ 54,368 - Unified Efficient Fine-Tuning of 100+ LLMs & VLMs (ACL 2024)
- **[ultralytics/ultralytics](https://github.com/ultralytics/ultralytics)** ⭐ 43,118 - Ultralytics YOLO11 🚀
- **[xitu/gold-miner](https://github.com/xitu/gold-miner)** ⭐ 34,199 - 🥇 掘金翻译计划，可能是世界最大最好的英译中技术社区，最懂读者和译者的翻译平台：
- **[microsoft/semantic-kernel](https://github.com/microsoft/semantic-kernel)** ⭐ 25,436 - Integrate cutting-edge LLM technology quickly and easily into your apps
- **[datawhalechina/pumpkin-book](https://github.com/datawhalechina/pumpkin-book)** ⭐ 25,020 - 《机器学习》（西瓜书）公式详解
- **[fastai/fastbook](https://github.com/fastai/fastbook)** ⭐ 23,397 - The fastai book, published as Jupyter Notebooks
- **[HqWu-HITCS/Awesome-Chinese-LLM](https://github.com/HqWu-HITCS/Awesome-Chinese-LLM)** ⭐ 20,655 - 整理开源的中文大语言模型，以规模较小、可私有化部署、训练成本较低的模型为主，包括底座模型，垂直领域微调及应用，数据集与教程等。
- **[recommenders-team/recommenders](https://github.com/recommenders-team/recommenders)** ⭐ 20,476 - Best Practices on Recommendation Systems
- **[ymcui/Chinese-LLaMA-Alpaca](https://github.com/ymcui/Chinese-LLaMA-Alpaca)** ⭐ 18,879 - 中文 LLaMA&Alpaca 大语言模型+本地 CPU/GPU 训练部署 (Chinese LLaMA & Alpaca LLMs)
- **[zziz/pwc](https://github.com/zziz/pwc)** ⭐ 15,398 - This repository is no longer maintained.
- **[mediar-ai/screenpipe](https://github.com/mediar-ai/screenpipe)** ⭐ 15,284 - AI app store powered by 24/7 desktop history. open source | 100% local | dev friendly | 24/7 screen, mic recording
- **[alyssaxuu/screenity](https://github.com/alyssaxuu/screenity)** ⭐ 14,981 - The free and privacy-friendly screen recorder with no limits 🎥
- **[mamoe/mirai](https://github.com/mamoe/mirai)** ⭐ 14,804 - 高效率 QQ 机器人支持库
- **[nltk/nltk](https://github.com/nltk/nltk)** ⭐ 14,175 - NLTK Source
- **[halfrost/Halfrost-Field](https://github.com/halfrost/Halfrost-Field)** ⭐ 13,112 - ✍🏻 这里是写博客的地方 —— Halfrost-Field 冰霜之地
- **[mlfoundations/open_clip](https://github.com/mlfoundations/open_clip)** ⭐ 12,175 - An open source implementation of CLIP.
- **[dottxt-ai/outlines](https://github.com/dottxt-ai/outlines)** ⭐ 12,095 - Structured Outputs
- **[Stability-AI/StableStudio](https://github.com/Stability-AI/StableStudio)** ⭐ 9,013 - Community interface for generative AI

- **[ai-collection/ai-collection](https://github.com/ai-collection/ai-collection)** ⭐ 8,276 - The Generative AI Landscape - A Collection of Awesome Generative AI Applications
- **[InternLM/InternLM](https://github.com/InternLM/InternLM)** ⭐ 6,979 - Official release of InternLM series (InternLM, InternLM2, InternLM2.5, InternLM3).
- **[raidendotai/cofounder](https://github.com/raidendotai/cofounder)** ⭐ 6,603 - ai-generated apps , full stack + generative UI
- **[Arize-ai/phoenix](https://github.com/Arize-ai/phoenix)** ⭐ 6,322 - AI Observability & Evaluation
- **[traceloop/openllmetry](https://github.com/traceloop/openllmetry)** ⭐ 6,083 - Open-source observability for your LLM application, based on OpenTelemetry
- **[aisingapore/TagUI](https://github.com/aisingapore/TagUI)** ⭐ 6,015 - Free RPA tool by AI Singapore
- **[chatopera/Synonyms](https://github.com/chatopera/Synonyms)** ⭐ 5,094 - :herb: 中文近义词：聊天机器人，智能问答工具包
- **[blinkospace/blinko](https://github.com/blinkospace/blinko)** ⭐ 4,990 - An open-source, self-hosted personal AI note tool prioritizing privacy, built using TypeScript .
- **[InternLM/xtuner](https://github.com/InternLM/xtuner)** ⭐ 4,646 - An efficient, flexible and full-featured toolkit for fine-tuning LLM (InternLM2, Llama3, Phi3, Qwen, Mistral, ...)
- **[jamesmurdza/awesome-ai-devtools](https://github.com/jamesmurdza/awesome-ai-devtools)** ⭐ 3,146 - Curated list of AI-powered developer tools.
- **[PRIS-CV/DemoFusion](https://github.com/PRIS-CV/DemoFusion)** ⭐ 2,020 - Let us democratise high-resolution generation! (CVPR 2024)
- **[manasky/lorem.space](https://github.com/manasky/lorem.space)** ⭐ 363 - ✨✨✨🪐✨✨✨  LOREM.SPACE ✨✨✨🪐✨✨✨

## Research & Data Analysis

_AI frameworks, machine learning tools, and data analysis platforms._

- **[tensorflow/models](https://github.com/tensorflow/models)** ⭐ 77,606 - Models and examples built with TensorFlow
- **[netdata/netdata](https://github.com/netdata/netdata)** ⭐ 75,099 - The fastest path to AI-powered full stack observability, even for lean teams.
- **[microsoft/ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)** ⭐ 74,715 - 12 weeks, 26 lessons, 52 quizzes, classic Machine Learning for all
- **[keras-team/keras](https://github.com/keras-team/keras)** ⭐ 63,208 - Deep Learning for humans
- **[ultralytics/yolov5](https://github.com/ultralytics/yolov5)** ⭐ 54,614 - YOLOv5 🚀 in PyTorch > ONNX > CoreML > TFLite
- **[vllm-project/vllm](https://github.com/vllm-project/vllm)** ⭐ 52,377 - A high-throughput and memory-efficient inference and serving engine for LLMs
- **[aymericdamien/TensorFlow-Examples](https://github.com/aymericdamien/TensorFlow-Examples)** ⭐ 43,665 - TensorFlow Tutorial and Examples for Beginners (support TF v1 & v2)
- **[OpenBB-finance/OpenBB](https://github.com/OpenBB-finance/OpenBB)** ⭐ 42,803 - Investment Research for Everyone, Everywhere.
- **[apachecn/ailearning](https://github.com/apachecn/ailearning)** ⭐ 41,126 - AiLearning：数据分析+机器学习实战+线性代数+PyTorch+NLTK+TF2
- **[hpcaitech/ColossalAI](https://github.com/hpcaitech/ColossalAI)** ⭐ 41,039 - Making large AI models cheaper, faster and more accessible
- **[streamlit/streamlit](https://github.com/streamlit/streamlit)** ⭐ 40,428 - Streamlit — A faster way to build and share data apps.
- **[floodsung/Deep-Learning-Papers-Reading-Roadmap](https://github.com/floodsung/Deep-Learning-Papers-Reading-Roadmap)** ⭐ 39,152 - Deep Learning papers reading roadmap for anyone who are eager to learn this amazing tech!
- **[ray-project/ray](https://github.com/ray-project/ray)** ⭐ 38,019 - Ray is an AI compute engine. Ray consists of a core distributed runtime and a set of AI Libraries for accelerating ML...
- **[google-research/google-research](https://github.com/google-research/google-research)** ⭐ 36,011 - Google Research
- **[milvus-io/milvus](https://github.com/milvus-io/milvus)** ⭐ 35,999 - Milvus is a high-performance, cloud-native vector database built for scalable vector ANN search
- **[fengdu78/Coursera-ML-AndrewNg-Notes](https://github.com/fengdu78/Coursera-ML-AndrewNg-Notes)** ⭐ 34,474 - 吴恩达老师的机器学习课程个人笔记
- **[TheAlgorithms/C-Plus-Plus](https://github.com/TheAlgorithms/C-Plus-Plus)** ⭐ 32,373 - Collection of various algorithms in mathematics, machine learning, computer science and physics implemented in C++ fo...
- **[yunjey/pytorch-tutorial](https://github.com/yunjey/pytorch-tutorial)** ⭐ 31,493 - PyTorch Tutorial for Deep Learning Researchers
- **[open-mmlab/mmdetection](https://github.com/open-mmlab/mmdetection)** ⭐ 31,365 - OpenMMLab Detection Toolbox and Benchmark
- **[tinygrad/tinygrad](https://github.com/tinygrad/tinygrad)** ⭐ 29,661 - You like pytorch? You like micrograd? You love tinygrad! ❤️

- **[google-research/tuning_playbook](https://github.com/google-research/tuning_playbook)** ⭐ 28,938 - A playbook for systematically maximizing the performance of deep learning models.
- **[ZuzooVn/machine-learning-for-software-engineers](https://github.com/ZuzooVn/machine-learning-for-software-engineers)** ⭐ 28,527 - A complete daily plan for studying to become a machine learning engineer.
- **[academic/awesome-datascience](https://github.com/academic/awesome-datascience)** ⭐ 26,879 - :memo: An awesome Data Science repository to learn and apply for real world problems.
- **[stanford-oval/storm](https://github.com/stanford-oval/storm)** ⭐ 26,644 - An LLM-powered knowledge curation system that researches a topic and generates a full-length report with citations.
- **[eriklindernoren/ML-From-Scratch](https://github.com/eriklindernoren/ML-From-Scratch)** ⭐ 26,639 - Machine Learning From Scratch. Bare bones NumPy implementations of machine learning models and algorithms with a focu...
- **[pjreddie/darknet](https://github.com/pjreddie/darknet)** ⭐ 26,237 - Convolutional Neural Networks
- **[Stability-AI/generative-models](https://github.com/Stability-AI/generative-models)** ⭐ 26,179 - Generative Models by Stability AI
- **[terryum/awesome-deep-learning-papers](https://github.com/terryum/awesome-deep-learning-papers)** ⭐ 25,907 - The most cited deep learning papers
- **[ChristosChristofidis/awesome-deep-learning](https://github.com/ChristosChristofidis/awesome-deep-learning)** ⭐ 25,670 - A curated list of awesome Deep Learning tutorials, projects and communities.
- **[matterport/Mask_RCNN](https://github.com/matterport/Mask_RCNN)** ⭐ 25,236 - Mask R-CNN for object detection and instance segmentation on Keras and TensorFlow
- **[qdrant/qdrant](https://github.com/qdrant/qdrant)** ⭐ 24,698 - Qdrant - High-performance, massive-scale Vector Database and Vector Search Engine for the next generation of AI. Also...
- **[microsoft/JARVIS](https://github.com/microsoft/JARVIS)** ⭐ 24,225 - JARVIS, a system to connect LLMs with ML community. Paper: https://arxiv.org/pdf/2303.17580.pdf
- **[shap/shap](https://github.com/shap/shap)** ⭐ 24,136 - A game theoretic approach to explain the output of any machine learning model.
- **[HumanSignal/label-studio](https://github.com/HumanSignal/label-studio)** ⭐ 23,276 - Label Studio is a multi-type data labeling and annotation tool with standardized output format
- **[microsoft/unilm](https://github.com/microsoft/unilm)** ⭐ 21,539 - Large-scale Self-supervised Pre-training Across Tasks, Languages, and Modalities
- **[mlflow/mlflow](https://github.com/mlflow/mlflow)** ⭐ 21,239 - Open source platform for the machine learning lifecycle
- **[Anjok07/ultimatevocalremovergui](https://github.com/Anjok07/ultimatevocalremovergui)** ⭐ 21,235 - GUI for a Vocal Remover that uses Deep Neural Networks.
- **[zergtant/pytorch-handbook](https://github.com/zergtant/pytorch-handbook)** ⭐ 21,067 - pytorch handbook 是一本开源的书籍，目标是帮助那些希望和使用 PyTorch 进行深度学习开发和研究的朋友快速入门，其中包含的 Pytorch 教程全部通过测试保证可以成功运行
- **[TheAlgorithms/C](https://github.com/TheAlgorithms/C)** ⭐ 20,488 - Collection of various algorithms in mathematics, machine learning, computer science, physics, etc implemented in C fo...
- **[huggingface/datasets](https://github.com/huggingface/datasets)** ⭐ 20,374 - 🤗 The largest hub of ready-to-use datasets for ML models with fast, easy-to-use and efficient data manipulation tools

- **[onnx/onnx](https://github.com/onnx/onnx)** ⭐ 19,252 - Open standard for machine learning interoperability
- **[ShusenTang/Dive-into-DL-PyTorch](https://github.com/ShusenTang/Dive-into-DL-PyTorch)** ⭐ 18,960 - 本项目将《动手学深度学习》(Dive into Deep Learning)原书中的 MXNet 实现改为 PyTorch 实现。
- **[EthicalML/awesome-production-machine-learning](https://github.com/EthicalML/awesome-production-machine-learning)** ⭐ 18,762 - A curated list of awesome open source libraries to deploy, monitor, version and scale your machine learning
- **[amark/gun](https://github.com/amark/gun)** ⭐ 18,504 - An open source cybersecurity protocol for syncing decentralized graph data.
- **[afshinea/stanford-cs-229-machine-learning](https://github.com/afshinea/stanford-cs-229-machine-learning)** ⭐ 18,329 - VIP cheatsheets for Stanford's CS 229 Machine Learning
- **[jtoy/awesome-tensorflow](https://github.com/jtoy/awesome-tensorflow)** ⭐ 17,391 - TensorFlow - A curated list of dedicated resources http://tensorflow.org
- **[microsoft/AirSim](https://github.com/microsoft/AirSim)** ⭐ 17,309 - Open source simulator for autonomous vehicles built on Unreal Engine / Unity, from Microsoft AI & Research
- **[microsoft/onnxruntime](https://github.com/microsoft/onnxruntime)** ⭐ 17,210 - ONNX Runtime: cross-platform, high performance ML inferencing and training accelerator
- **[thunlp/GNNPapers](https://github.com/thunlp/GNNPapers)** ⭐ 16,480 - Must-read papers on graph neural networks (GNN)
- **[instillai/TensorFlow-Course](https://github.com/instillai/TensorFlow-Course)** ⭐ 16,371 - :satellite: Simple and ready-to-use tutorials for TensorFlow
- **[Mikoto10032/DeepLearning](https://github.com/Mikoto10032/DeepLearning)** ⭐ 16,139 - 深度学习入门教程, 优秀文章, Deep Learning Tutorial
- **[ddbourgin/numpy-ml](https://github.com/ddbourgin/numpy-ml)** ⭐ 16,125 - Machine learning, in numpy
- **[piskvorky/gensim](https://github.com/piskvorky/gensim)** ⭐ 16,099 - Topic Modelling for Humans
- **[cmusatyalab/openface](https://github.com/cmusatyalab/openface)** ⭐ 15,312 - Face recognition with deep neural networks.
- **[kailashahirwar/cheatsheets-ai](https://github.com/kailashahirwar/cheatsheets-ai)** ⭐ 15,252 - Essential Cheat Sheets for deep learning and machine learning researchers https://medium.com/@kailashahirwar/essentia...
...
- **[iterative/dvc](https://github.com/iterative/dvc)** ⭐ 14,664 - 🦉 Data Versioning and ML Experiments
- **[tensorflow/tfjs-models](https://github.com/tensorflow/tfjs-models)** ⭐ 14,562 - Pretrained models for TensorFlow.js
- **[karpathy/nn-zero-to-hero](https://github.com/karpathy/nn-zero-to-hero)** ⭐ 14,522 - Neural Networks: Zero to Hero
- **[mrdbourke/pytorch-deep-learning](https://github.com/mrdbourke/pytorch-deep-learning)** ⭐ 14,365 - Materials for the Learn PyTorch for Deep Learning: Zero to Mastery course.

- **[stas00/ml-engineering](https://github.com/stas00/ml-engineering)** ⭐ 14,328 - Machine Learning Engineering Open Book
- **[virgili0/Virgilio](https://github.com/virgili0/Virgilio)** ⭐ 14,136 - Your new Mentor for Data Science E-Learning.
- **[davidsandberg/facenet](https://github.com/davidsandberg/facenet)** ⭐ 14,134 - Face recognition using Tensorflow
- **[davisking/dlib](https://github.com/davisking/dlib)** ⭐ 14,066 - A toolkit for making real world machine learning and data analysis applications in C++
- **[cvat-ai/cvat](https://github.com/cvat-ai/cvat)** ⭐ 14,060 - Annotate better with CVAT, the industry-leading data engine for machine learning. Used and trusted by teams at any sc...
- **[aishwaryanr/awesome-generative-ai-guide](https://github.com/aishwaryanr/awesome-generative-ai-guide)** ⭐ 13,358 - A one stop repository for generative AI research updates, interview resources, notebooks and much more!
- **[visenger/awesome-mlops](https://github.com/visenger/awesome-mlops)** ⭐ 13,229 - A curated list of references for MLOps
- **[DataTalksClub/mlops-zoomcamp](https://github.com/DataTalksClub/mlops-zoomcamp)** ⭐ 13,003 - Free MLOps course from DataTalks.Club
- **[carla-simulator/carla](https://github.com/carla-simulator/carla)** ⭐ 12,730 - Open-source simulator for autonomous driving research.
- **[apache/tvm](https://github.com/apache/tvm)** ⭐ 12,450 - Open deep learning compiler stack for cpu, gpu and specialized accelerators
- **[tensorflow/playground](https://github.com/tensorflow/playground)** ⭐ 12,439 - Play with neural networks!
- **[jikexueyuanwiki/tensorflow-zh](https://github.com/jikexueyuanwiki/tensorflow-zh)** ⭐ 12,378 - 谷歌全新开源人工智能系统 TensorFlow 官方文档中文版
- **[zalandoresearch/fashion-mnist](https://github.com/zalandoresearch/fashion-mnist)** ⭐ 12,360 - A MNIST-like fashion product database. Benchmark :point_down:
- **[marcotcr/lime](https://github.com/marcotcr/lime)** ⭐ 11,937 - Lime: Explaining the predictions of any machine learning classifier
- **[AccumulateMore/CV](https://github.com/AccumulateMore/CV)** ⭐ 11,800 - ✔（已完结）最全面的 深度学习 笔记【土堆 Pytorch】【李沐 动手学深度学习】【吴恩达 深度学习】
- **[dair-ai/ML-Papers-of-the-Week](https://github.com/dair-ai/ML-Papers-of-the-Week)** ⭐ 11,627 - 🔥Highlighting the top ML papers every week.
- **[DLR-RM/stable-baselines3](https://github.com/DLR-RM/stable-baselines3)** ⭐ 11,105 - PyTorch version of Stable Baselines, reliable implementations of reinforcement learning algorithms.
- **[rushter/MLAlgorithms](https://github.com/rushter/MLAlgorithms)** ⭐ 10,865 - Minimal and clean examples of machine learning algorithms implementations
- **[qubvel-org/segmentation_models.pytorch](https://github.com/qubvel-org/segmentation_models.pytorch)** ⭐ 10,679 - Semantic segmentation models with 500+ pretrained convolutional and transformer-based backbones.
- **[aws/amazon-sagemaker-examples](https://github.com/aws/amazon-sagemaker-examples)** ⭐ 10,591 - Example 📓 Jupyter notebooks that demonstrate how to build, train, and deploy machine learning models using 🧠 Amazon S...

- **[DataTalksClub/machine-learning-zoomcamp](https://github.com/DataTalksClub/machine-learning-zoomcamp)** ⭐ 10,539 - Learn ML engineering for free in 4 months!
- **[kedro-org/kedro](https://github.com/kedro-org/kedro)** ⭐ 10,433 - Kedro is a toolbox for production-ready data science. It uses software engineering best practices to help you create ...
- **[ultralytics/yolov3](https://github.com/ultralytics/yolov3)** ⭐ 10,421 - YOLOv3 in PyTorch > ONNX > CoreML > TFLite
- **[lexfridman/mit-deep-learning](https://github.com/lexfridman/mit-deep-learning)** ⭐ 10,326 - Tutorials, assignments, and competitions for MIT Deep Learning related courses.
- **[doccano/doccano](https://github.com/doccano/doccano)** ⭐ 10,144 - Open source annotation tool for machine learning practitioners.
- **[Yorko/mlcourse.ai](https://github.com/Yorko/mlcourse.ai)** ⭐ 10,119 - Open Machine Learning Course
- **[wandb/wandb](https://github.com/wandb/wandb)** ⭐ 10,095 - The AI developer platform. Use Weights & Biases to train and fine-tune models, and manage models from experimentation...
- **[timzhang642/3D-Machine-Learning](https://github.com/timzhang642/3D-Machine-Learning)** ⭐ 10,026 - A resource repository for 3D machine learning
- **[ymcui/Chinese-BERT-wwm](https://github.com/ymcui/Chinese-BERT-wwm)** ⭐ 10,020 - Pre-Training with Whole Word Masking for Chinese BERT（中文 BERT-wwm 系列模型）
- **[bigscience-workshop/petals](https://github.com/bigscience-workshop/petals)** ⭐ 9,721 - 🌸 Run LLMs at home, BitTorrent-style. Fine-tuning and inference up to 10x faster than offloading
- **[jadore801120/attention-is-all-you-need-pytorch](https://github.com/jadore801120/attention-is-all-you-need-pytorch)** ⭐ 9,288 - A PyTorch implementation of the Transformer model in "Attention is All You Need".
- **[oceanbase/oceanbase](https://github.com/oceanbase/oceanbase)** ⭐ 9,270 - The Fastest Distributed Database for Transactional, Analytical, and AI Workloads. Welcome to our community: https://...
- **[Netflix/metaflow](https://github.com/Netflix/metaflow)** ⭐ 8,973 - Build, Manage and Deploy AI/ML Systems
- **[vahidk/EffectiveTensorflow](https://github.com/vahidk/EffectiveTensorflow)** ⭐ 8,610 - TensorFlow tutorials and best practices.
- **[openvinotoolkit/openvino](https://github.com/openvinotoolkit/openvino)** ⭐ 8,582 - OpenVINO™ is an open source toolkit for optimizing and deploying AI inference
- **[postgresml/postgresml](https://github.com/postgresml/postgresml)** ⭐ 6,391 - Postgres with GPUs for ML/AI apps.
- **[lyogavin/airllm](https://github.com/lyogavin/airllm)** ⭐ 5,850 - AirLLM 70B inference with single 4GB GPU
- **[mishushakov/llm-scraper](https://github.com/mishushakov/llm-scraper)** ⭐ 5,312 - Turn any webpage into structured data using LLMs
- **[argilla-io/argilla](https://github.com/argilla-io/argilla)** ⭐ 4,581 - Argilla is a collaboration tool for AI engineers and domain experts to build high-quality datasets
- **[objectbox/objectbox-java](https://github.com/objectbox/objectbox-java)** ⭐ 4,525 - Database for Android and JVM - first and fast, lightweight on-device vector database

- **[crate/crate](https://github.com/crate/crate)** ⭐ 4,265 - CrateDB is a distributed and scalable SQL database for storing and analyzing massive amounts of data in near real-tim...
- **[neo4j-labs/llm-graph-builder](https://github.com/neo4j-labs/llm-graph-builder)** ⭐ 3,709 - Neo4j graph construction from unstructured data using LLMs
- **[cozodb/cozo](https://github.com/cozodb/cozo)** ⭐ 3,667 - A transactional, relational-graph-vector database that uses Datalog for query. The hippocampus for AI!
- **[SciSharp/TensorFlow.NET](https://github.com/SciSharp/TensorFlow.NET)** ⭐ 3,360 - .NET Standard bindings for Google's TensorFlow for developing, training and deploying Machine Learning models in C# a...
- **[filipecalegario/awesome-generative-ai](https://github.com/filipecalegario/awesome-generative-ai)** ⭐ 2,956 - A curated list of Generative AI tools, works, models, and references
- **[pinecone-io/examples](https://github.com/pinecone-io/examples)** ⭐ 2,916 - Jupyter Notebooks to help you get hands-on with Pinecone vector databases
- **[bighuang624/AI-research-tools](https://github.com/bighuang624/AI-research-tools)** ⭐ 2,705 - :hammer:AI 方向好用的科研工具
- **[tensorchord/pgvecto.rs](https://github.com/tensorchord/pgvecto.rs)** ⭐ 2,080 - Scalable, Low-latency and Hybrid-enabled Vector Search in Postgres. Revolutionize Vector Search, not Database.
- **[zilliztech/attu](https://github.com/zilliztech/attu)** ⭐ 2,061 - Web UI for Milvus Vector Database
- **[Mintplex-Labs/vector-admin](https://github.com/Mintplex-Labs/vector-admin)** ⭐ 1,965 - The universal tool suite for vector database management. Manage Pinecone, Chroma, Qdrant, Weaviate and more vector da...
- **[dingodb/dingo](https://github.com/dingodb/dingo)** ⭐ 1,600 - A multi-modal vector database that supports upserts and vector queries using unified SQL (MySQL-Compatible) on struct...
- **[juji-io/datalevin](https://github.com/juji-io/datalevin)** ⭐ 1,277 - A simple, fast and versatile Datalog database

## Video & Animation

_AI applications for video creation, editing, and animation._

- **[hacksider/Deep-Live-Cam](https://github.com/hacksider/Deep-Live-Cam)** ⭐ 71,787 - real time face swap and one-click video deepfake with only a single image
- **[Developer-Y/cs-video-courses](https://github.com/Developer-Y/cs-video-courses)** ⭐ 69,381 - List of Computer Science courses with video lectures.
- **[deepfakes/faceswap](https://github.com/deepfakes/faceswap)** ⭐ 54,256 - Deepfakes Software For All
- **[xinntao/Real-ESRGAN](https://github.com/xinntao/Real-ESRGAN)** ⭐ 31,719 - Real-ESRGAN aims at developing Practical Algorithms for General Image/Video Restoration.
- **[google-ai-edge/mediapipe](https://github.com/google-ai-edge/mediapipe)** ⭐ 30,651 - Cross-platform, customizable ML solutions for live and streaming media.
- **[huggingface/diffusers](https://github.com/huggingface/diffusers)** ⭐ 29,800 - 🤗 Diffusers: State-of-the-art diffusion models for image, video, and audio generation in PyTorch and FLAX.
- **[wandb/openui](https://github.com/wandb/openui)** ⭐ 21,591 - OpenUI let's you describe UI using your imagination, then see it rendered live.
- **[serengil/deepface](https://github.com/serengil/deepface)** ⭐ 19,697 - A Lightweight Face Recognition and Facial Attribute Analysis (Age, Gender, Emotion and Race) Library for Python
- **[graphdeco-inria/gaussian-splatting](https://github.com/graphdeco-inria/gaussian-splatting)** ⭐ 17,765 - Original reference implementation of "3D Gaussian Splatting for Real-Time Radiance Field Rendering"
- **[dair-ai/ML-YouTube-Courses](https://github.com/dair-ai/ML-YouTube-Courses)** ⭐ 16,714 - 📺 Discover the latest machine learning / AI courses on YouTube.
- **[k4yt3x/video2x](https://github.com/k4yt3x/video2x)** ⭐ 13,938 - A machine learning-based video super resolution and frame interpolation framework. Est. Hack the Valley II, 2018.
- **[owainlewis/awesome-artificial-intelligence](https://github.com/owainlewis/awesome-artificial-intelligence)** ⭐ 12,071 - A curated list of Artificial Intelligence (AI) courses, books, video lectures and papers.
- **[Hvass-Labs/TensorFlow-Tutorials](https://github.com/Hvass-Labs/TensorFlow-Tutorials)** ⭐ 9,279 - TensorFlow Tutorials with YouTube Videos
- **[activeloopai/deeplake](https://github.com/activeloopai/deeplake)** ⭐ 8,723 - Database for AI. Store Vectors, Images, Texts, Videos, etc. Use with LLMs/LangChain. Store, query, version, & visuali...
- **[Olow304/memvid](https://github.com/Olow304/memvid)** ⭐ 8,198 - Video-based AI memory library. Store millions of text chunks in MP4 files with lightning-fast semantic search. No dat...
- **[krillinai/KlicStudio](https://github.com/krillinai/KlicStudio)** ⭐ 8,081 - A video translation and dubbing tool powered by LLMs, offering professional-grade translations and one-click full-pr...
- **[vietnh1009/ASCII-generator](https://github.com/vietnh1009/ASCII-generator)** ⭐ 7,938 - ASCII generator (image to text, image to image, video to video)
- **[YaoFANGUK/video-subtitle-remover](https://github.com/YaoFANGUK/video-subtitle-remover)** ⭐ 7,226 - 基于 AI 的图片/视频硬字幕去除、文本水印去除，无损分辨率生成去字幕、去水印后的图片/视频文件。无需申请第三方 API，本地实现。AI-based tool for removing hard-coded subtitles and te...
- **[open-mmlab/mmagic](https://github.com/open-mmlab/mmagic)** ⭐ 7,205 - OpenMMLab Multimodal Advanced, Generative, and Intelligent Creation Toolbox. Unlock the magic 🪄: Generative-AI (AIGC)...
- **[enricoros/big-AGI](https://github.com/enricoros/big-AGI)** ⭐ 6,538 - AI suite powered by state-of-the-art models and providing advanced AI/AGI functions. It features AI personas, AGI fun...

- **[vladmandic/sdnext](https://github.com/vladmandic/sdnext)** ⭐ 6,453 - SD.Next: All-in-one WebUI for AI generative image and video creation
- **[MODSetter/SurfSense](https://github.com/MODSetter/SurfSense)** ⭐ 5,981 - Open Source Alternative to NotebookLM / Perplexity / Glean, connected to external sources such as search engines (Tav...
- **[modelscope/FunClip](https://github.com/modelscope/FunClip)** ⭐ 4,756 - Open-source, accurate and easy-to-use video speech recognition & clipping tool, LLM based AI clipping intergrated.
- **[nateraw/stable-diffusion-videos](https://github.com/nateraw/stable-diffusion-videos)** ⭐ 4,611 - Create 🔥 videos with Stable Diffusion by exploring the latent space and morphing between text prompts
- **[ddean2009/MoneyPrinterPlus](https://github.com/ddean2009/MoneyPrinterPlus)** ⭐ 4,547 - AI 一键批量生成各类短视频,自动批量混剪短视频,自动把视频发布到抖音,快手,小红书,视频号上,赚钱从来没有这么容易过! 支持本地语音模型 chatTTS,fasterwhisper,GPTSoVITS,支持云语音：Azure,阿里云,腾...
- **[Picsart-AI-Research/Text2Video-Zero](https://github.com/Picsart-AI-Research/Text2Video-Zero)** ⭐ 4,197 - [ICCV 2023 Oral] Text-to-Image Diffusion Models are Zero-Shot Video Generators
- **[OpenGVLab/Ask-Anything](https://github.com/OpenGVLab/Ask-Anything)** ⭐ 3,268 - [CVPR2024 Highlight][VideoChatGPT] ChatGPT with video understanding! And many more supported LMs such as miniGPT4, St...
- **[crmne/ruby_llm](https://github.com/crmne/ruby_llm)** ⭐ 2,556 - Stop juggling AI SDKs! RubyLLM offers one delightful Ruby interface for OpenAI, Anthropic, Gemini, Bedrock, OpenRoute...
- **[cirosantilli/china-dictatorship](https://github.com/cirosantilli/china-dictatorship)** ⭐ 2,468 - 反中共政治宣传库。Anti Chinese government propaganda. 住在中国真名用户的网友请别给星星，不然你要被警察请喝茶。常见问答集，新闻集和饭店和音乐建议。卐习万岁卐。冠状病毒审查郝海东新疆改造中心六四事件法...
- **[SamurAIGPT/AI-Youtube-Shorts-Generator](https://github.com/SamurAIGPT/AI-Youtube-Shorts-Generator)** ⭐ 2,406 - A python tool that uses GPT-4, FFmpeg, and OpenCV to automatically analyze videos, extract the most interesting secti...
- **[6174/comflowyspace](https://github.com/6174/comflowyspace)** ⭐ 2,297 - Comflowyspace is an intuitive, user-friendly, open-source AI tool for generating images and videos, democratizing acc...
- **[milvus-io/bootcamp](https://github.com/milvus-io/bootcamp)** ⭐ 2,178 - Dealing with all unstructured data, such as reverse image search, audio search, molecular search, video analysis, que...
- **[CiaraStrawberry/TemporalKit](https://github.com/CiaraStrawberry/TemporalKit)** ⭐ 1,961 - An all in one solution for adding Temporal Stability to a Stable Diffusion Render via an automatic1111 extension
- **[kyechan99/capsule-render](https://github.com/kyechan99/capsule-render)** ⭐ 1,470 - 🌈 Dynamic Coloful Image Render
- **[jaaronkot/picprose](https://github.com/jaaronkot/picprose)** ⭐ 691 - Better cover image generator tool for Medium, YouTube, BiliBili, Blog and many others
- **[universome/stylegan-v](https://github.com/universome/stylegan-v)** ⭐ 378 - [CVPR 2022] StyleGAN-V: A Continuous Video Generator with the Price, Image Quality and Perks of StyleGAN2
- **[Jasonnor/th-music-video-generator](https://github.com/Jasonnor/th-music-video-generator)** ⭐ 278 - Touhou Project random music video generator/player, crawling image and video from websites to generate MV.
- **[snap-research/MoCoGAN-HD](https://github.com/snap-research/MoCoGAN-HD)** ⭐ 245 - [ICLR 2021 Spotlight] A Good Image Generator Is What You Need for High-Resolution Video Synthesis

## Voice Generation & Conversion

_Advanced AI systems for voice cloning, synthesis, and conversion._

- **[babysor/MockingBird](https://github.com/babysor/MockingBird)** ⭐ 36,452 - 🚀AI 拟声: 5 秒内克隆您的声音并生成任意语音内容 Clone a voice in 5 seconds to generate arbitrary speech in real-time
- **[mudler/LocalAI](https://github.com/mudler/LocalAI)** ⭐ 33,881 - :robot: The free, Open Source alternative to OpenAI, Claude and others. Self-hosted and local-first. Drop-in replacem...
- **[FunAudioLLM/CosyVoice](https://github.com/FunAudioLLM/CosyVoice)** ⭐ 15,194 - Multi-lingual large voice generation model, providing inference, training and deployment full-stack ability.
- **[FurkanGozukara/Stable-Diffusion](https://github.com/FurkanGozukara/Stable-Diffusion)** ⭐ 2,479 - FLUX, Stable Diffusion, SDXL, SD3, LoRA, Fine Tuning, DreamBooth, Training, Automatic1111, Forge WebUI, SwarmUI, Deep...

## Writing & Editing

_AI-powered tools for content creation, text generation, and language processing._

- **[xtekky/gpt4free](https://github.com/xtekky/gpt4free)** ⭐ 64,645 - The official gpt4free repository | various collection of powerful language models | o4, o3 and deepseek r1, gpt-4.1, ...
- **[dair-ai/Prompt-Engineering-Guide](https://github.com/dair-ai/Prompt-Engineering-Guide)** ⭐ 59,501 - 🐙 Guides, papers, lecture, notebooks and resources for prompt engineering
- **[mlabonne/llm-course](https://github.com/mlabonne/llm-course)** ⭐ 57,429 - Course to get into Large Language Models (LLMs) with roadmaps and Colab notebooks.
- **[exacity/deeplearningbook-chinese](https://github.com/exacity/deeplearningbook-chinese)** ⭐ 36,576 - Deep Learning Book Chinese Translation
...
- **[eugeneyan/applied-ml](https://github.com/eugeneyan/applied-ml)** ⭐ 28,116 - 📚 Papers & tech blogs by companies sharing their work on data science & machine learning in production.
- **[JaidedAI/EasyOCR](https://github.com/JaidedAI/EasyOCR)** ⭐ 27,279 - Ready-to-use OCR with 80+ supported languages and all popular writing scripts including Latin, Chinese, Arabic, Devan...
- **[pytorch/examples](https://github.com/pytorch/examples)** ⭐ 23,224 - A set of examples around pytorch in Vision, Text, Reinforcement Learning, etc.
- **[jingyaogong/minimind](https://github.com/jingyaogong/minimind)** ⭐ 23,109 - 🚀🚀 「大模型」2 小时完全从 0 训练 26M 的小参数 GPT！🌏 Train a 26M-parameter GPT from scratch in just 2h!
- **[karpathy/minGPT](https://github.com/karpathy/minGPT)** ⭐ 22,269 - A minimal PyTorch re-implementation of the OpenAI GPT (Generative Pretrained Transformer) training
- **[keon/awesome-nlp](https://github.com/keon/awesome-nlp)** ⭐ 17,340 - :book: A curated list of resources dedicated to Natural Language Processing (NLP)
- **[NLP-LOVE/ML-NLP](https://github.com/NLP-LOVE/ML-NLP)** ⭐ 16,948 - 此项目是机器学习(Machine Learning)、深度学习(Deep Learning)、NLP 面试中常考到的知识点和代码实现，也是作为一个算法工程师必会的理论基础知识。
- **[AI4Finance-Foundation/FinGPT](https://github.com/AI4Finance-Foundation/FinGPT)** ⭐ 16,653 - FinGPT: Open-Source Financial Large Language Models! Revolutionize 🔥 We release the trained model on HuggingFace.
- **[oxford-cs-deepnlp-2017/lectures](https://github.com/oxford-cs-deepnlp-2017/lectures)** ⭐ 15,848 - Oxford Deep NLP 2017 course
- **[graykode/nlp-tutorial](https://github.com/graykode/nlp-tutorial)** ⭐ 14,668 - Natural Language Processing Tutorial for Deep Learning Researchers
- **[donnemartin/awesome-aws](https://github.com/donnemartin/awesome-aws)** ⭐ 13,607 - A curated list of awesome Amazon Web Services (AWS) libraries, open source repos, guides, blogs, and other resources....
- **[Lightning-AI/litgpt](https://github.com/Lightning-AI/litgpt)** ⭐ 12,494 - 20+ high-performance LLMs with recipes to pretrain, finetune and deploy at scale.
- **[karpathy/char-rnn](https://github.com/karpathy/char-rnn)** ⭐ 11,810 - Multi-layer Recurrent Neural Networks (LSTM, GRU, RNN) for character-level language models in Torch
- **[TheR1D/shell_gpt](https://github.com/TheR1D/shell_gpt)** ⭐ 11,115 - A command-line productivity tool powered by AI large language models like GPT-4, will help you accomplish your tasks ...
- **[google/sentencepiece](https://github.com/google/sentencepiece)** ⭐ 11,088 - Unsupervised text tokenizer for Neural Network-based text generation.

- **[databrickslabs/dolly](https://github.com/databrickslabs/dolly)** ⭐ 10,807 - Databricks’ Dolly, a large language model trained on the Databricks Machine Learning Platform
- **[fastai/numerical-linear-algebra](https://github.com/fastai/numerical-linear-algebra)** ⭐ 10,540 - Free online textbook of Jupyter notebooks for fast.ai Computational Linear Algebra course
- **[huggingface/text-generation-inference](https://github.com/huggingface/text-generation-inference)** ⭐ 10,328 - Large Language Model Text Generation Inference
- **[yandexdataschool/nlp_course](https://github.com/yandexdataschool/nlp_course)** ⭐ 10,178 - YSDA course in Natural Language Processing
- **[stanfordnlp/CoreNLP](https://github.com/stanfordnlp/CoreNLP)** ⭐ 9,934 - CoreNLP: A Java suite of core NLP tools for tokenization, sentence segmentation, NER, parsing, coreference, sentiment...
- **[brightmart/nlp_chinese_corpus](https://github.com/brightmart/nlp_chinese_corpus)** ⭐ 9,744 - 大规模中文自然语言处理语料 Large Scale Chinese Corpus for NLP
- **[NirantK/awesome-project-ideas](https://github.com/NirantK/awesome-project-ideas)** ⭐ 8,420 - Curated list of Machine Learning, NLP, Vision, Recommender Systems Project Ideas
- **[friuns2/BlackFriday-GPTs-Prompts](https://github.com/friuns2/BlackFriday-GPTs-Prompts)** ⭐ 8,260 - List of free GPTs that doesn't require plus subscription
- **[civitai/civitai](https://github.com/civitai/civitai)** ⭐ 6,728 - A repository of models, textual inversions, and more
- **[RediSearch/RediSearch](https://github.com/RediSearch/RediSearch)** ⭐ 5,876 - A query and indexing engine for Redis, providing secondary indexing, full-text search, vector similarity search and a...
- **[trigaten/Learn_Prompting](https://github.com/trigaten/Learn_Prompting)** ⭐ 4,523 - Prompt Engineering, Generative AI, and LLM Guide by Learn Prompting | Join our discord for the largest Prompt Enginee...
- **[infiniflow/infinity](https://github.com/infiniflow/infinity)** ⭐ 3,894 - The AI-native database built for LLM applications, providing incredibly fast hybrid search of dense vector, sparse ve...
- **[GanymedeNil/document.ai](https://github.com/GanymedeNil/document.ai)** ⭐ 3,679 - 基于向量数据库与 GPT3.5 的通用本地知识库方案(A universal local knowledge base solution based on vector database and GPT3.5)
- **[phodal/prompt-patterns](https://github.com/phodal/prompt-patterns)** ⭐ 3,078 - Prompt 编写模式：如何将思维框架赋予机器，以设计模式的形式来思考 prompt
- **[kuzudb/kuzu](https://github.com/kuzudb/kuzu)** ⭐ 2,825 - Embedded property graph database built for speed. Vector search and full-text search built in. Implements Cypher.
- **[peremartra/Large-Language-Model-Notebooks-Course](https://github.com/peremartra/Large-Language-Model-Notebooks-Course)** ⭐ 1,649 - Practical course about Large Language Models.
- **[jackaduma/Recurrent-LLM](https://github.com/jackaduma/Recurrent-LLM)** ⭐ 193 - The open-source LLM implementation of paper: RecurrentGPT: Interactive Generation of (Arbitrarily) Long Text. AI 写小...

## Project Statistics

_Real data from our AI tool discovery and categorization system._

### Collection Overview

- **📊 Total Projects**: 737 open source AI tools
- **🔍 Data Source**: GitHub repositories crawled with automated classification
- **📅 Last Updated**: January 2025
- **🌟 Quality Filter**: Minimum 50 stars for inclusion

### Category Distribution

| Category                             | Projects | Percentage |
| ------------------------------------ | -------- | ---------- |
| **Image Generation & Editing**       | 214      | 29.0%      |
| **Chatbots & Virtual Companions**    | 149      | 20.2%      |
| **Research & Data Analysis**         | 112      | 15.2%      |
| **Coding & Development**             | 106      | 14.4%      |
| **Video & Animation**                | 38       | 5.2%       |
| **Writing & Editing**                | 37       | 5.0%       |
| **Other AI Tools**                   | 32       | 4.3%       |
| **Music & Audio**                    | 18       | 2.4%       |
| **Gaming & Entertainment**           | 6        | 0.8%       |
| **Education & Translation**          | 6        | 0.8%       |
| **Business Management**              | 6        | 0.8%       |
| **Marketing & Advertising**          | 5        | 0.7%       |
| **Voice Generation & Conversion**    | 4        | 0.5%       |
| **Developer Tools & Infrastructure** | 4        | 0.5%       |

### Quality Metrics

- **High Impact (10,000+ ⭐)**: Top-tier projects with massive community adoption
- **Popular (1,000-9,999 ⭐)**: Well-established projects with strong communities
- **Growing (100-999 ⭐)**: Emerging projects showing potential
- **New (50-99 ⭐)**: Fresh projects meeting our minimum threshold
...
- ✅ **Open Source**: Must have publicly available source code
- ✅ **AI/ML Focus**: Clear artificial intelligence or machine learning functionality
- ✅ **Active Development**: Regular commits and maintenance (updated within 12 months)
- ✅ **Quality Threshold**: Minimum 50 GitHub stars or demonstrated community adoption
- ✅ **Functional**: Working implementation, not just concepts or abandoned projects
- ✅ **Well Documented**: Clear README and usage instructions

### How to contribute:

1. Fork this repository
2. Follow the format: `**[Tool Name](link)** ⭐ stars - Brief description`
3. Ensure the tool meets our inclusion criteria
4. Submit a pull request with clear description

### Automated Updates

This list is maintained through automated crawling of GitHub repositories. Our system:

- 🔍 **Discovers** new AI tools through keyword-based search
